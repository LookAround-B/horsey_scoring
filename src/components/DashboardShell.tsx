...
import {
  ...
  UserCircle, Pen, Shield, UserCheck, Layers, FilePlus2, KeyRound,
} from "lucide-react";
...
const NAV: Record<UserRole, NavItem[]> = {
  ...
  club: [
    HOME_ITEM,
    { label: "Events",         href: "/dashboard/club",               icon: Calendar },
    { label: "Riders",         href: "/dashboard/club/riders",        icon: Users },
    { label: "Scores",         href: "/dashboard/club/scores",        icon: Trophy },
  ],
  rider: [
...
export function DashboardShell({ children }: { children: React.ReactNode }) {
  ...
  // Apply the saved text size app-wide (controls live on the profile page).
  useEffect(() => {
    try {
