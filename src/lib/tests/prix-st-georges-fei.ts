...
export const movements: Movement[] = [
  ...
  { no: "13", letters: "",                        test: "The collected walk C–H–G–(M)–G–(H)–G–M",                                                                            coefficient: 2, directive: "Regularity, suppleness of back, activity, shortening and heightening of steps, self-carriage. Transition into walk." },
...
export const config: TestConfig = {
  label: "Prix St. Georges (FEI)",
  appendix: "D-PSG09-2009/2022",
  abbr: "PSG FEI",
