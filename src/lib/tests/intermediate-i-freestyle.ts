...
export const movements: Movement[] = [
  ...
  { no: "11", letters: "", test: "Flying changes every third stride (minimum 5 times consecutively)",                coefficient: 1, directive: "" },
  { no: "12", letters: "", test: "Flying changes every second stride (minimum 5 times consecutively)",               coefficient: 1, directive: "" },
  { no: "13", letters: "", test: "Single pirouette in canter right",                                                 coefficient: 2, directive: "" },
  { no: "14", letters: "", test: "Single pirouette in canter left",                                                  coefficient: 2, directive: "" },
...
export const config: TestConfig = {
  label: "Intermediate I Freestyle",
  appendix: "Appendix 'A'",
  abbr: "Int I FS",
